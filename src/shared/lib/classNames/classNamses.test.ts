...
describe('classNames', () => {
    ...
    test('with additional true class', () => {
        ...
        expect(classNames('someClass', { modClass1: true }, ['class1'])).toBe(
            result,
        );
    });
    ...
    test('with additional false class', () => {
        const result = 'someClass class1';
        expect(classNames('someClass', { modClass1: false }, ['class1'])).toBe(
            result,
        );
    });
    ...
    test('with additional false undefined', () => {
        const result = 'someClass class1';
        expect(
            classNames('someClass', { modClass1: undefined }, ['class1']),
        ).toBe(result);
    });
});
